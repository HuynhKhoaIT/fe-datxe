...
export const ModalEventCalendar = ({
    ...
    const form = useForm({
        ...
        validate: {
            ...
            customer_request: (value) => (value.length < 1 ? 'Vui lòng nhập yêu cầu' : null),
        },
    });
        ...
        <Box>
            <form onSubmit={form.onSubmit((values) => handleSubmit(values))}>
                ...
                <Grid gutter={10} mt="md">
                    <Grid.Col span={6}>
                        <TextInput placeholder="Họ và tên" withAsterisk {...form.getInputProps('full_name')} />
                    </Grid.Col>
                    <Grid.Col span={6}>
                        <TextInput placeholder="Số điện thoại" withAsterisk {...form.getInputProps('phone_number')} />
                    </Grid.Col>
                </Grid>
