                                        ...
                                        <div className="blog-meta">
                                            <div className="blog-meta-left">
                                                <ul>
                                                    ...
                                                    <li>
                                                        <i className="far fa-comments"></i>3.2k Comments
                                                    </li>
                                                    <li>
                                                        <i className="far fa-thumbs-up"></i>1.4k Like
                                                    </li>
                                                </ul>
                                            </div>
                                        ...
                                        <div className="blog-author">
                                            ...
                                            <div className="author-info">
                                                ...
                                                <p>
                                                    ...
                                                    the abcd readable content of a page when looking at its layout that
                                                    more less.
                                                </p>
                                        ...
                                        <div className="blog-comments-wrapper">
                                            <div className="blog-comments-single">
                                                ...
                                                <div className="blog-comments-content">
                                                    <h5>Jesse Sinkler</h5>
                                                    <span>
                                                        <i className="far fa-clock"></i> January 31, 2023
                                                    </span>
                                                    <p>
                            ...
                            <aside className="sidebar">
                                ...
                                <div className="widget category">
                                    ...
                                    <div className="category-list">
                                        <a href="#">
                                            <i className="far fa-arrow-right"></i>Auto Dealing<span>(10)</span>
                                        </a>
                                        <a href="#">
                                            <i className="far fa-arrow-right"></i>Car News<span>(15)</span>
                                        </a>
                                        <a href="#">
                                            <i className="far fa-arrow-right"></i>Engine Solution<span>(20)</span>
                                        </a>
                                        <a href="#">
                                            <i className="far fa-arrow-right"></i>Car Buy Tips<span>(30)</span>
                                        </a>
                                        <a href="#">
                                            <i className="far fa-arrow-right"></i>Top Brands<span>(25)</span>
                                        </a>
                                    </div>
                                </div>
                                {/* <!-- recent post --> */}
                                <div className="widget recent-post">
                                    ...
                                    <div className="recent-post-single">
                                        ...
                                        <div className="recent-post-bio">
                                            <h6>
                                                <a href="#">At vero accusa iusto odio dignis ducimu bland</a>
                                            </h6>
                                            <span>
                                                <i className="far fa-clock"></i>January 31, 2023
                                            </span>
