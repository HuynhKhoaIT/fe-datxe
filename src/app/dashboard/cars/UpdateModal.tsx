...
const UpdateModal = ({
  ...
  useEffect(() => {
    ...
    if (opened == true) {
      ...
      form.setFieldValue(
        "date_repairt",
        data?.dateRepairt ? dayjs(data?.dateRepairt).toDate() : null
      );
      form.setFieldValue(
      ...
      form.setFieldValue(
        ...
        dayjs(data.civilInsuranceDate).toDate()
      );
      form.setFieldValue(
        "material_insurance_deadline",
        dayjs(data?.materialInsuranceDate).toDate()
      );
    }
  }, [opened]);
            ...
            <Grid.Col span={4}>
              <Select
                ...
                onChange={(value) => {
                  ...
                  form.setFieldValue("year_car_id", null);
                }}
              />
            </Grid.Col>
            <Grid.Col span={4}>
          ...
          <Grid gutter={10}>
            <Grid.Col span={4}>
              <Select
                ...
                data={yearCar}
                {...form.getInputProps("year_car_id")}
              ></Select>
            </Grid.Col>
            <Grid.Col span={4}>
              <TextInput
