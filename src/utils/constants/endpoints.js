...
export const GET_PRODUCT_ENDPOINT = `${process.env.apiGuest}/products`;
...
export const POST_LOGIN_ENDPOINT = `${process.env.apiGuest}/login`;
export const POST_REGISTER_ENDPOINT = `${process.env.apiGuest}/register`;
